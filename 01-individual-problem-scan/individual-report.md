...
- Vai trò / bối cảnh: Sinh viên năm 4, Trường Đại học Công nghệ Thông tin, ĐHQG-HCM. Ngoài lịch học và project, mình thường tham gia tổ chức hoạt động ngoại khóa nên phải theo dõi khá nhiều cuộc họp, đầu việc, checklist và deadline cùng lúc.
- Công việc hằng tuần:
...
| 5 | Lặp lại / Tốn thời gian | Khi thực hiện build/train/test code phải quay lại check terminal nhiều lần để xem code đã chạy xong hay có lỗi gì không | Sinh viên AI/Software, developer, researcher chạy build/train/test hoặc đồng đội đang chờ model/result/artifact. | UC Irvine dẫn nghiên cứu cho biết cần khoảng 23 phút để quay lại trạng thái tập trung sau một interruption. Đây cũng là pain đã có công cụ hỗ trợ: GitHub Actions có thể báo khi workflow chạy xong và cho biết status thành công/thất bại. **Nguồn tham khảo:** [UC Irvine News](https://news.uci.edu/2020/11/21/asynchronous-communications-can-help-reclaim-lost-time/) và [GitHub Actions notifications](https://docs.github.com/en/actions/concepts/workflows-and-actions/notifications-for-workflow-runs). |
| 6 | Lặp lại | Tải nhiều file rồi thực hiện đổi tên từng file theo format yêu cầu | Sinh viên hoặc thành viên BTC phải quản lý nhiều tài liệu/ảnh/file submission hoặc người tổng hợp file hoặc người nhận nếu naming không chuẩn. | Một review về file management ghi nhận người dùng tương tác hằng ngày với việc tải, di chuyển, đặt tên, tìm, chia sẻ và xóa file. Nghiên cứu về quản lý thông tin của sinh viên cao học cũng liệt kê re-naming, re-grouping và deleting là các hoạt động duy trì collection. **Nguồn tham khảo:** [The ubiquitous digital file: A review](https://arxiv.org/abs/2109.09668) và [nghiên cứu về quản lý electronic information](https://asistdl.onlinelibrary.wiley.com/doi/full/10.1002/meet.2011.14504801246). |
| 7 | Pain / Lặp lại | Khi môn hết slot phải thường xuyên vào hệ thống để kiểm tra xem có người huỷ môn hoặc mở thêm slot để đăng ký | Sinh viên cần đăng ký môn bắt buộc/môn đúng tiến độ hoặc cố vấn học tập/phòng đào tạo khi sinh viên không thể xây lịch học phù hợp. | UCLA dẫn khảo sát của Instructure: 85% sinh viên gặp khó khăn khi đăng ký môn cần thiết; gần 3/4 cho rằng thiếu chỗ học làm tăng khả năng phải học thêm học kỳ. Vanderbilt vận hành waitlist tự động 8 lần/ngày, mỗi 3 giờ, khi có chỗ trống. **Nguồn tham khảo:** [UCLA Luskin](https://luskin.ucla.edu/news/how-course-shutouts-are-delaying-graduation-for-many-college-students/) và [Vanderbilt Waitlist Process](https://www.vanderbilt.edu/enrollmentbulletin/registration-essentials/waitlist-process/). |
| 8 | Tốn thời gian / AI có thể làm tốt hơn | Sau khi họp xong phải tự viết biên bản, tổng hợp các kết luận trong cuộc họp thủ công | Thư ký/người được giao ghi biên bản hoặc toàn bộ thành viên cuộc họp, trưởng nhóm/BTC và người vắng họp cần decision/action item. | Microsoft thử nghiệm 60 nhân viên tóm tắt recording 35 phút: nhóm dùng Copilot mất 11 phút 13 giây, so với 42 phút 34 giây ở nhóm không dùng. Độ đầy đủ giảm nhẹ (11/15 so với 12/15 chi tiết), nên vẫn cần human review. **Nguồn tham khảo:** [Microsoft WorkLab](https://www.microsoft.com/en-us/worklab/work-trend-index/copilots-earliest-users-teach-us-about-generative-ai-at-work). |
...
- Ý dùng được: AI giúp mình biến các quan sát rời rạc thành actor, workflow, bottleneck và cách đo. Nó cũng gợi ý những điểm kiểm soát hợp lý, như notification cho job hoặc người review biên bản, để mình tách được phần nào nên tự động hóa và phần nào vẫn cần người xác nhận.
- Ý bỏ vì không phải pain thật: Ý tưởng kiểu một trợ lý quản lý hết lịch, task và email nghe hấp dẫn nhưng quá rộng so với pain mình đang gặp. Với build/train/test, mình cũng không chọn “AI agent” vì notification hoặc rule đã giải quyết đúng nhu cầu chính, nhẹ hơn nhiều.
...
2. Sau họp, kết luận và đầu việc nằm rải trong note, chat hoặc recording. **(Bước gặp vấn đề)**
3. Xem lại note/chat/recording.
4. Tổng hợp các nội dung chính.
5. Xác định kết luận, action item, owner và deadline.
6. Format biên bản và gửi cho các thành viên.

Bottleneck (bước 2–3): Sau họp, kết luận và đầu việc bị rải trong note, chat hoặc recording, nên người phụ trách phải đọc/xem lại nội dung để tự xác định đâu là thông tin quan trọng, decision và action item.
...
[1 Tham gia meeting + note]
        ↓
[2 Decision/action item nằm rải trong note/chat/recording]  <-- bước gặp vấn đề
        ↓
[3 Xem lại note/recording + tổng hợp nội dung]  <-- bottleneck
        ↓
...
2. Email có lịch bị lẫn với email thông thường hoặc thông tin thiếu rõ ràng. **(Bước gặp vấn đề)**
3. Đọc/phân loại từng email.
4. Xác định email nào chứa lịch họp/gặp mặt.
5. Trích xuất ngày, giờ, địa điểm/link.
6. Mở Calendar và nhập lại event.
7. Kiểm tra lịch trùng.

Bottleneck (bước 2–3): Email chứa lịch bị lẫn với email thường hoặc viết mơ hồ, nên người dùng phải đọc thủ công để nhận ra email liên quan và lấy đúng thông tin sự kiện.
...
[1 Check inbox]
      ↓
[2 Email có lịch lẫn với email thường / thông tin mơ hồ]  <-- bước gặp vấn đề
      ↓
[3 Đọc/phân loại email + tìm ngày/giờ/địa điểm]  <-- bottleneck
      ↓
[4 Mở Calendar]
      ↓
...
2. Job chạy lâu hoặc có thể lỗi nhưng không có thông báo chủ động. **(Bước gặp vấn đề)**
3. Chuyển sang làm công việc khác.
4. Sau một khoảng thời gian quay lại terminal.
5. Đọc log và kiểm tra trạng thái.
6. Nếu chưa xong thì tiếp tục chờ và kiểm tra lại.
7. Nếu lỗi thì đọc log để tìm nguyên nhân.

Bottleneck (bước 2–4): Job chạy lâu hoặc có thể lỗi nhưng không chủ động báo trạng thái, nên người dùng phải polling thủ công và liên tục chuyển giữa công việc đang làm với terminal để biết job đã xong hay lỗi.
...
[1 Start job]
      ↓
[2 Job chạy lâu / có thể lỗi nhưng không chủ động báo]  <-- bước gặp vấn đề
      ↓
[3 Làm task khác rồi quay lại terminal để check]  <-- bottleneck / interruption
      ↓
[4 Check log]
      ↓
   chưa xong
...
```
Hiện tại, mỗi khi có email mới mình phải tự đọc để xem email nào thực sự có lịch họp hoặc gặp mặt. Nếu có, mình lại nhặt ngày, giờ, địa điểm rồi nhập thủ công vào Calendar. Phần mất công nhất không phải bấm tạo event, mà là tìm đúng email và chắc rằng mình không đọc nhầm thông tin.

Việc này lặp lại khá nhiều vì mình vừa học nhiều môn, vừa làm project và tham gia hoạt động ngoại khóa. Bỏ sót một email đôi khi không chỉ mất vài phút mà còn dẫn tới quên hoặc trễ lịch họp. Vì vậy, mình muốn thử xem AI có thể bớt thao tác thủ công đến đâu mà vẫn để người dùng là người xác nhận cuối cùng.

Microsoft Work Trend Index cho thấy nhóm 25% người dùng email nhiều nhất có thể dành khoảng 8,8 giờ mỗi tuần cho email, và 62% người được khảo sát cho rằng họ mất quá nhiều thời gian để tìm kiếm thông tin. Những con số này không nói riêng về sinh viên, nhưng chúng cho thấy một điều quen thuộc: khi thông tin đến từ quá nhiều nơi, việc tìm đúng thứ mình cần đã là một pain đáng để xử lý.
```
