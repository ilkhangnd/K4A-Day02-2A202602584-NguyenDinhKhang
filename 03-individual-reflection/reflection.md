...
|---|---|---|---|---|
| Scan | Gợi ý cách nhìn problem theo mức lặp lại, thời gian mất và người bị ảnh hưởng. | Giúp mình chuyển quan sát hằng ngày thành câu hỏi có thể đo. | Có lúc AI gợi ý pain quá rộng, không đúng với trải nghiệm của mình. | Chỉ giữ 8 vấn đề đã quan sát; bỏ ý tưởng trợ lý “làm hết mọi thứ”. |
| Problem Card | Gợi ý các câu hỏi về bottleneck, metric và phương án không dùng AI. | Nhắc mình đặt bước người review cho email và biên bản. | Dễ khiến card nào cũng trông như phải có AI. | Chọn notification/rule là giải pháp chính cho terminal. |
| Workflow | Hỗ trợ diễn đạt flow trước và sau rõ hơn. | Làm lộ ra handoff, fallback và chỗ cần người kiểm tra. | Không thể biết chính xác nhóm mất bao lâu trên dự án thật. | Giữ các con số là ước lượng và yêu cầu phải bấm giờ ở pilot. |
| Research | Tìm survey, paper và tài liệu công cụ để có danh sách nguồn ban đầu. | Giúp thấy nhanh mối liên hệ giữa occlusion, association và ID switch. | AI có thể diễn giải nguồn quá rộng, chẳng hạn biến một thách thức MOT thành kết luận riêng về ID switch; benchmark người/xe cũng khác video lợn. | Đối chiếu lại nguồn gốc, ghi rõ evidence thứ cấp và giới hạn khi áp dụng sang domain khác. |
| Problem Statement | Chỉ ra các chỗ còn mơ hồ như ground truth và định nghĩa ID switch. | Ép nhóm nói rõ AI can thiệp ở đâu và không được làm gì. | Không thể tự đặt threshold thay cho nhóm. | Bổ sung precision, recall, IDSW, spot-check và human-approved correction. |
| Rule / Workflow / Agent | Gợi ý khung so sánh ba mức tự động hóa. | Làm rõ Agent không tự nhiên tốt hơn Workflow. | Nếu không giới hạn scope, AI thường nghiêng về phương án phức tạp. | Chọn workflow cố định và chỉ cân nhắc AI sau baseline rule. |
| Decision | Không dùng AI để chốt quyết định. | Chỉ dùng AI như người hỏi ngược, không phải người ra quyết định. | AI không có dữ liệu pilot và cũng không chịu trách nhiệm với dữ liệu đó. | Giữ Not Yet, kèm những điều kiện có thể đo trước khi Go. |
