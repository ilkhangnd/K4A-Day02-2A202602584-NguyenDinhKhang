...
| Survey / poll (evidence thứ cấp) | 2 nghiên cứu công bố: 40 annotator ở nghiên cứu tracking video; 7 người xử lý 30 video ở user study camera trap | [Nghiên cứu annotation video tracking](https://doi.org/10.1609/hcomp.v11i1.27555) kết hợp telemetry và survey của 40 annotator, cho thấy độ phức tạp tác vụ làm thay đổi cách phân bổ thời gian và thời gian tự báo cáo có thể lệch thời gian quan sát. [User study về tagging video động vật](https://doi.org/10.1002/wlb3.01539) cho 7 người xử lý 30 video: quy trình bán tự động mất 768 ± 83 giây, so với 3.111 ± 269 giây khi làm tay (xấp xỉ nhanh hơn 4 lần); điểm dễ thực hiện lần lượt là 7,4 ± 0,9 và 2,0 ± 0,3 trên thang 1–10. | Khác domain: vehicle tracking/camera trap, không phải QA ID switch cho video lợn. Các số trên không thể dùng làm baseline hoặc cam kết ROI của nhóm. | Dùng như bằng chứng thứ cấp cho pitch: video review/annotation có pain về thời gian và UX. Trước khi Go, nhóm vẫn chạy script ở mục 4.1a với 5–10 phản hồi hoặc 2 interview + bấm giờ trên video lợn. |
